...
const propertiesData = [
  {
    ...
    features: ['Modern kitchen', 'Off-street parking', 'Private rear garden', 'En-suite to principal bedroom', 'Close to local amenities'],
  ...
  },
  {
    ...
    features: ['Separate fitted kitchen', 'Two double bedrooms', 'Modern bathroom', 'Communal garden access'],
  ...
  },
  {
    ...
    features: ['Two reception rooms', 'Kitchen-diner', 'Four bedrooms', 'Rear garden', 'Garage', 'Quiet residential road'],
...
async function seed() {
  ...
  for (const prop of propertiesData) {
    ...
    const doc = { ...prop, _type: 'property', _id: propId, branch: { _type: 'reference', _ref: 'scaffold-demo-branch-central' } }
