...
const agentsData = [
  {
    ...
    order: 1,
    bio: pt(
      'Demo agent profile used to exercise the scaffold\'s agent page template.'
    ),
  },
  {
    name: 'Sam Example',
...
async function main() {
  ...
  if (!branch) {
    console.error('❌ Demo branch "scaffold-demo-branch-central" not found. Run scripts/seed.js first.')
    process.exit(1)
  }
